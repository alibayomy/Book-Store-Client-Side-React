                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                  ...
                  <li>
                    ...
                    <ul class="collapse nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
                      ...
                      <li >
                        <input class="form-check-input mySmallCheckbox" value="ar" onChange={(e) => handelChangeLang(e)}
                          type="radio" name="flexRadioDefault" id="flexRadioDefault1" />
                        <label class="form-check-label d-sm-inline mySmallText ms-1 " for="flexRadioDefault1">Arabic Books </label>
                      </li>

                      <li>
                        <input class="form-check-input mySmallCheckbox" type="radio" value="en" onChange={(e) => handelChangeLang(e)}
                          name="flexRadioDefault" id="flexRadioDefault2" />

                        <label class="form-check-label d-sm-inline mySmallText  ms-1" for="flexRadioDefault2">English Books </label>
                      </li>
                      <li>
                        <input class="form-check-input  mySmallCheckbox" type="radio" value="fr" onChange={(e) => handelChangeLang(e)}
